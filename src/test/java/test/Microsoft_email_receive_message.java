...
public class Microsoft_email_receive_message extends DRIVER{
	...
	public void mail_signin() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.name("loginfmt")).sendKeys("sagorsaha746@hotmail.com",Keys.ENTER);
		Thread.sleep(1000);
		
		//password field
		driver.findElement(By.id("i0118")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("i0118")).sendKeys("(\"S.K.Sagor746\")",Keys.ENTER);//("S.K.Sagor746")
		Thread.sleep(1500);
