...
public class Reservation_without_signin_and_payment_failed extends DRIVER {
	@Test(priority=1, description = " In this case, without sign in i am making a "
			+ "reservation and Reservation payment is failed")
	...
	public void payment() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"sections\"]/div/table/tbody/tr/td[1]/table/tbody/tr[3]/td[2]/form/input[5]")).click();
		Thread.sleep(3000);
		
		String ti = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div/main/div[2]/h1")).getText();
		
		if(ti.equalsIgnoreCase("Oh no!")==true) {
			System.out.println("Test passed...");
			Thread.sleep(4000);
			driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div/main/div[2]/div/button")).click();
		}else {
